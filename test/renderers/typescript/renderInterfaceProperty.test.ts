...
describe('renderInterfaceProperty()', () => {
    it('works with unrequired properties', () => {
        expect(
            renderInterfaceProperty('property', 'type', false, false).trim(),
        ).toMatchInlineSnapshot(`"property?: type | undefined;"`);
    });

    it('works with required properties', () => {
        expect(
            renderInterfaceProperty('property', 'type', true, false).trim(),
    ...
    it('supports localized fields', () => {
        expect(
            renderInterfaceProperty('property', 'type', false, true).trim(),
